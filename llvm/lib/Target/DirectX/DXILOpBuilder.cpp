...
CallInst *DXILOpBuilder::createDXILOpCall(dxil::OpCode OpCode, Version SMVer,
...
Type *DXILOpBuilder::getOverloadTy(dxil::OpCode OpCode, Version SMVer,
                                   FunctionType *FT) {
